...
- `LiveSPICE Generic`: a generic LiveSPICE LV2 shell with mono input/output and `schematicPath` state support. It currently passes audio through until the managed LiveSPICE simulation engine is bridged into the native LV2 runtime.
